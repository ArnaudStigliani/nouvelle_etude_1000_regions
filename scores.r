...
ARF_pos <- readDNAStringSet('ARF2_1000_pos.fas')#[(1:1000)]
...
list_neg <- list('ARF2_1000_1_neg.fas','ARF2_1000_2_neg.fas','ARF2_1000_3_neg.fas','ARF2_1000_4_neg.fas')
...
dev.copy(device = png, filename = 'ROC_ARF2_negative_set.png', width = 800, height = 600) 
dev.off()
